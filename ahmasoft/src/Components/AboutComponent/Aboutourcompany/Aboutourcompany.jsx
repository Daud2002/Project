...
export default function Aboutourcompany() {
    return (
        <div className='flex md:flex-row flex-col justify-around mt-16 gap-8 md:gap-0 max-w-[1440px]'>
            ...
            <div className='md:w-[40%] w-full px-4'>
                ...
                <p className='my-4 text-justify'>At Ahmasoft, we believe in transforming your ideas into reality. As a dedicated partner in your journey towards innovation, we specialize in providing cutting-edge web scraping, automation and data visualization services. Our goal is to empower your business with the insights and tools needed to stay ahead in today’s data-driven world.</p>
