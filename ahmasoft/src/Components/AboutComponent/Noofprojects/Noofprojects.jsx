        ...
        <div className='flex md:flex-row flex-col gap-16 md:gap-0 justify-around my-20'>
            <div className='flex flex-col items-center'>
                <div className='relative'>
                    {counterOn && <CountUp start={0} end={8} duration={2} delay={0} className='text-[3.5rem] font-bold italic' />}<span className='absolute top-0 -right-6 font-bold text-[2rem] text-primary'>+</span>
                </div>
            ...
            <div className='flex flex-col items-center'>
                <div className='relative'>
                    {counterOn && <CountUp start={0} end={2} duration={2} delay={0} className='text-[3.5rem] font-bold italic' />}<span className='absolute top-0 -right-6 font-bold text-[2rem] text-primary'>+</span>
                </div>
